...
public class MPanel extends JPanel implements WindowListener{
 ...
 public MPanel(RManage manager){
  ...
  options =EngineOptions.newBuilder(HARDWARE_ACCELERATED).licenseKey("1BNDHFSC1G1D6ZMU95085G9AA0MCPI5UCD711TOT1EJ0TZ02V9BTB69RH7CJMLTQ6SAOGB").build();
  ...
  addressBar=new JTextField("https://www.google.com/maps/d/edit?mid=1eeJUX_qcIgk_48UXdaYzKHluFNFNIcwl&ll=24.987909365128758%2C121.57600009424775&z=17");
   ...
   public void actionPerformed(ActionEvent e1) {
	...
	try {
		...
		//System.out.print(String.valueOf(listCombo.getSelectedItem()));
    ...
    EngineOptions option =EngineOptions.newBuilder(HARDWARE_ACCELERATED).licenseKey("1BNDHFSC1G1D6ZMU95085G9AA0MCPI5UCD711TOT1EJ0TZ02V9BTB69RH7CJMLTQ6SAOGB").build();
